...
export const categoryBadgeDocs: ComponentDocumentation = {
  ...
  <div>
    ...
    {
      name: 'Interactive Category Badges',
      description: 'Clickable category badges for filtering or navigation. Automatically becomes a button with full keyboard support and focus indicators when onClick is provided.',
      code: `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
  <div>
    <p style={{ marginBottom: '8px', fontSize: '14px', color: '#666' }}>Click to filter by category</p>
    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
      <CategoryBadge 
        color="blue" 
        onClick={() => console.log('Filter by Shopping')}
      >
        Shopping
      </CategoryBadge>
      <CategoryBadge 
        color="orange" 
        onClick={() => console.log('Filter by Food')}
      >
        Food & Dining
      </CategoryBadge>
      <CategoryBadge 
        color="yellow" 
        onClick={() => console.log('Filter by Transport')}
      >
        Transport
      </CategoryBadge>
      <CategoryBadge 
        color="purple" 
        onClick={() => console.log('Filter by Entertainment')}
      >
        Entertainment
      </CategoryBadge>
    </div>
  ...
  <div>
    <p style={{ marginBottom: '8px', fontSize: '14px', color: '#666' }}>With disabled state</p>
    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
      <CategoryBadge 
        color="blue" 
