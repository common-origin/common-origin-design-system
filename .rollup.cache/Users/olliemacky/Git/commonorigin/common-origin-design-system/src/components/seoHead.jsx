...
import { DEFAULT_SEO, mergeSEOConfig, ORGANIZATION_SCHEMA } from '../lib/seo';
/**
...
export var SEOHead = function (_a) {
    var _b = _a.config, config = _b === void 0 ? {} : _b, _c = _a.noindex, noindex = _c === void 0 ? false : _c, children = _a.children;
    // Merge with defaults
    var seoConfig = mergeSEOConfig(DEFAULT_SEO, config);
    // Generate robots content
    var robotsContent = noindex ? 'noindex, nofollow' : (seoConfig.robots || 'index, follow');
    return (<Head>
      {/* Basic Meta Tags */}
      <title>{seoConfig.title}</title>
      <meta name="description" content={seoConfig.description}/>
      {seoConfig.keywords && seoConfig.keywords.length > 0 && (<meta name="keywords" content={seoConfig.keywords.join(', ')}/>)}
      ...
      {seoConfig.structuredData && (<script type="application/ld+json" dangerouslySetInnerHTML={{
 ...
 */
export var EnhancedMeta = function () {
    return (<>
      <Head>
        {/* Favicons */}
...
//# sourceMappingURL=seoHead.jsx.map