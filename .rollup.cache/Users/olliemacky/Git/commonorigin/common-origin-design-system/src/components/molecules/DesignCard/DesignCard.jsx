...
export var DesignCard = function (_a) {
    var title = _a.title, excerpt = _a.excerpt, _b = _a.labels, labels = _b === void 0 ? [] : _b, tag = _a.tag, coverImage = _a.coverImage, date = _a.date, onReadMore = _a.onReadMore, readMoreHref = _a.readMoreHref, _c = _a.readMoreText, readMoreText = _c === void 0 ? "Read more" : _c;
    if (tag === 'design') {
        return (<>
        <DesignCardStyled>
          <ImageWrapper>
          ...
          <ContentSection>
            <ContentWrapper>
              <Stack direction="column" gap="md">
                ...
                {(onReadMore || readMoreHref) && (<ButtonWrapper>
                    {readMoreHref ? (<Button purpose="link" url={readMoreHref}>
                        {readMoreText}
                      </Button>) : (<Button onClick={onReadMore}>
                        {readMoreText}
                      </Button>)}
                  </ButtonWrapper>)}
              </Stack>
