...
export var DateFormatter = function (_a) {
    var dateString = _a.dateString, _b = _a.formatString, formatString = _b === void 0 ? 'yyyy' : _b, dataTestId = _a["data-testid"];
    var date = parseISO(dateString);
    return (<TimeStyled dateTime={dateString} data-testid={dataTestId}>
